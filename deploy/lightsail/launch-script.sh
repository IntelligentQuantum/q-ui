...
# /etc/q-ui/install-result.env and open it under the instance's Networking tab
...
#   export QUI_PANEL_PORT="54321"
# Other optional pins (unset => secure random):
#   export QUI_USERNAME="admin2"
#   export QUI_PASSWORD="change-me"
#   export QUI_WEB_BASE_PATH="panel"
# Domain TLS instead of plain HTTP:
#   export QUI_SSL_MODE="domain" QUI_DOMAIN="panel.example.com" QUI_ACME_EMAIL="you@example.com"
# ----------------------------------------------------------------------------
...
# the full credentials stay in the root-only /etc/q-ui/install-result.env
