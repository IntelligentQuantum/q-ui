...
import { RHFText, RHFNumber, RHFTextarea, RHFSelect, RHFSwitch, RHFField, useFormContext, useWatch } from '@/components/form/rhf';
...
export default function HysteriaFields()
{
    ...
    return (
    <>
      <RHFNumber name="streamSettings.hysteriaSettings.version" label={t('pages.inbounds.form.version')} min={2} max={2} disabled />
      <RHFNumber name="streamSettings.hysteriaSettings.udpIdleTimeout" label={t('pages.inbounds.form.udpIdleTimeout')} min={1} />
