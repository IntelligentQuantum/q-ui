...
export const AllSettingSchema = z.object({
  clientCostMember: z.number().int().min(0),
  clientCostPerGBMember: z.number().int().min(0),
  clientCostPerGBReseller: z.number().int().min(0),
  clientCostReseller: z.number().int().min(0),
  cryptoBonusEnabled: z.boolean(),
  cryptoBonusMax: z.number().int().min(0),
  cryptoBonusMinDeposit: z.number().int().min(0),
  cryptoBonusPercent: z.number().int().min(0).max(100),
  cryptoExchangeRate: z.number().int().min(1),
  datepicker: z.string(),
  ...
  registrationEnable: z.boolean(),
  remarkModel: z.string(),
  resetTrafficCostMember: z.number().int().min(0),
  resetTrafficCostPerGBMember: z.number().int().min(0),
  resetTrafficCostPerGBReseller: z.number().int().min(0),
  resetTrafficCostReseller: z.number().int().min(0),
  ...
  zarinpalCurrency: z.string(),
  zarinpalEnable: z.boolean(),
  zarinpalMerchantId: z.string(),
