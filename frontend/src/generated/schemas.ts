...
export const SCHEMAS: Record<string, unknown> = {
  "AllSetting": {
    ...
    "properties": {
      "clientCostMember": {
        "description": "Flat credits charged to a member per client created",
        "minimum": 0,
        "type": "integer"
      },
      "clientCostPerGBMember": {
        "description": "Credits/GB charged to a member on client create",
        "minimum": 0,
        "type": "integer"
      },
      "clientCostPerGBReseller": {
        "description": "Credits/GB charged to a reseller on client create",
        "minimum": 0,
        "type": "integer"
      },
      "clientCostReseller": {
        "description": "Per-role pricing. The charge depends on the acting (buyer) user's role:\nadmins are always free (no field), resellers and members each have their\nown rate. Total = base + perGB × quotaGB, computed per role.\nFlat credits charged to a reseller per client created",
        "minimum": 0,
        "type": "integer"
      },
      "cryptoBonusEnabled": {
        "description": "Enable the crypto deposit bonus",
        "type": "boolean"
      },
      "cryptoBonusMax": {
        "description": "Maximum bonus (credits); 0 = uncapped",
        "minimum": 0,
        "type": "integer"
      },
      "cryptoBonusMinDeposit": {
        "description": "Minimum deposit (credits) to qualify for the bonus",
        "minimum": 0,
        "type": "integer"
      },
      "cryptoBonusPercent": {
        "description": "Bonus % credited on top of a crypto deposit",
        "maximum": 100,
        "minimum": 0,
        "type": "integer"
      },
      "cryptoExchangeRate": {
        "description": "Wallet credits per 1 unit of the invoice currency",
        "minimum": 1,
        "type": "integer"
      },
      "datepicker": {
      ...
      "plisioSandbox": {
        "description": "Reserved: Plisio exposes no separate sandbox host",
        "type": "boolean"
      },
      "plisioSecretKey": {
        "description": "Plisio Secret Key (API + webhook); redacted in view",
        "type": "string"
      },
      "plisioSourceCurrency": {
        "description": "Fiat currency invoices are priced in (e.g. USD)",
        "type": "string"
      },
      "referralCommissionPercent": {
        "description": "% of a referred user's purchase credited to the referrer",
        "maximum": 100,
        "minimum": 0,
        "type": "integer"
      },
      "registrationEnable": {
        "description": "Allow public self-registration of new panel users",
        "type": "boolean"
      },
      "remarkModel": {
      ...
      "resetTrafficCostMember": {
        "description": "Flat credits charged to a member per traffic reset",
        "minimum": 0,
        "type": "integer"
      },
      "resetTrafficCostPerGBMember": {
        "description": "Credits/GB charged to a member on traffic reset",
        "minimum": 0,
        "type": "integer"
      },
      "resetTrafficCostPerGBReseller": {
        "description": "Credits/GB charged to a reseller on traffic reset",
        "minimum": 0,
        "type": "integer"
      },
      "resetTrafficCostReseller": {
        "description": "Flat credits charged to a reseller per traffic reset",
        "minimum": 0,
        "type": "integer"
      },
      ...
      "zarinpalCurrency": {
        "description": "Amount currency: IRR | IRT",
        "type": "string"
      },
      "zarinpalEnable": {
        "description": "Reseller / billing (ZarinPal balance top-up)\nEnable ZarinPal balance top-up",
        "type": "boolean"
      },
      "zarinpalMerchantId": {
        "description": "ZarinPal 36-char merchant id",
        "type": "string"
      },
      "zarinpalSandbox": {
        "description": "Use ZarinPal sandbox endpoint",
        "type": "boolean"
      }
    },
    "required": [
