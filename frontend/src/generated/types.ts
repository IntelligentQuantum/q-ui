...
export interface AllSetting {
  clientCostMember: number;
  clientCostPerGBMember: number;
  clientCostPerGBReseller: number;
  clientCostReseller: number;
  ...
  remarkModel: string;
  resetTrafficCostMember: number;
  resetTrafficCostPerGBMember: number;
  resetTrafficCostPerGBReseller: number;
  resetTrafficCostReseller: number;
