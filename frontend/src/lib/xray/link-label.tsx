...
{
    return (
    <span className="inline-flex shrink-0 items-center gap-1 tracking-[0.3px]">
      <Badge variant="neutral">{parts.protocol}</Badge>
      {parts.network && <Badge variant="neutral">{parts.network}</Badge>}
      {parts.security && <Badge variant="neutral">{parts.security}</Badge>}
    </span>
    );
}
