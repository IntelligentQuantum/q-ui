...
export const AllSettingSchema = z.object({
    ...
    panelTitleLtr: z.string().max(60).optional(),
    panelTitleRtl: z.string().max(60).optional(),
    ...
    smtpEnable: z.boolean().optional(),
    smtpHost: z.string().optional(),
    smtpPort: port.optional(),
    smtpUsername: z.string().optional(),
    smtpPassword: z.string().optional(),
    smtpTo: z.string().optional(),
    smtpEncryptionType: z.string().optional(),
    smtpEnabledEvents: z.string().optional(),
    smtpCpu: z.number().int().min(0).max(100).optional(),
    twoFactorEnable: z.boolean().optional(),
    twoFactorToken: z.string().optional(),
    registrationEnable: z.boolean().optional(),
    clientCostReseller: z.number().int().min(0).optional(),
    clientCostMember: z.number().int().min(0).optional(),
    clientCostPerGBReseller: z.number().int().min(0).optional(),
    clientCostPerGBMember: z.number().int().min(0).optional(),
    resetTrafficCostReseller: z.number().int().min(0).optional(),
    resetTrafficCostMember: z.number().int().min(0).optional(),
    resetTrafficCostPerGBReseller: z.number().int().min(0).optional(),
    resetTrafficCostPerGBMember: z.number().int().min(0).optional(),
    ...
    plisioEnable: z.boolean().optional(),
    plisioSecretKey: z.string().optional(),
    plisioSandbox: z.boolean().optional(),
    plisioSourceCurrency: z.string().optional(),
    cryptoExchangeRate: z.number().optional(),
    cryptoBonusEnabled: z.boolean().optional(),
    cryptoBonusPercent: z.number().optional(),
    cryptoBonusMinDeposit: z.number().optional(),
    cryptoBonusMax: z.number().optional(),
    ...
    hasPlisioSecretKey: z.boolean().optional(),
