...
export const MtprotoInboundSettingsSchema = z.object({
    ...
    // '' is the form's "default" choice (mtg picks the resolver's order); treated
    // as unset by the backend.
    preferIp: z.enum(['prefer-ipv6', 'prefer-ipv4', 'only-ipv6', 'only-ipv4']).or(z.literal('')).optional(),
