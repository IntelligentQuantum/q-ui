...
// "q-ui setting" hit the same database backend as the panel. godotenv.Load does
...
func main() {
	...
	migrateDbCmd.StringVar(&migrateSrc, "src", "", "Source SQLite file (defaults to the configured q-ui.db)")
	...
	flag.Usage = func() {
		...
		fmt.Println("    migrate        migrate form other/old q-ui")
