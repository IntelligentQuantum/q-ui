...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/IntelligentQuantum/3x-ui/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/IntelligentQuantum/3x-ui/main/update.sh)
    if [[ $? == 0 ]]; then
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/IntelligentQuantum/3x-ui/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/IntelligentQuantum/3x-ui/master/install.sh)${plain}"
    echo ""
