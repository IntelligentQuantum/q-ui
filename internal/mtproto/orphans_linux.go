...
// previous q-ui run and returns how many were killed.
//
// q-ui starts one mtg process per mtproto inbound outside its own lifecycle, and
...
// domain-fronted to the FakeTLS domain instead of proxied to Telegram. q-ui is
