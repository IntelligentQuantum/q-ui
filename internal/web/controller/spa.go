...
// XUIController is the main controller for the Q-UI panel, managing sub-controllers.
...
func (a *XUIController) initRouter(g *gin.RouterGroup) {
	...
	g.GET("/managers", a.panelSPA)
	g.GET("/workspace-settings", a.panelSPA)
	g.GET("/tenant-users", a.panelSPA)
	g.GET("/workspace-payments", a.panelSPA)
	...
	// Manual card-to-card deposit pages: buyer submission/history and the
	// admin review queue + payment-card management.
	g.GET("/manual-deposit", a.panelSPA)
	g.GET("/manual-deposits", a.panelSPA)
	// Support ticketing: list, detail (/tickets/:id), and the staff dashboard.
