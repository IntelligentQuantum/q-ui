...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/IntelligentQuantum/q-ui/main/update.sh)
    if [[ $? == 0 ]]; then
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/IntelligentQuantum/q-ui/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/IntelligentQuantum/q-ui/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    curl -fLRo /usr/bin/q-ui -z /usr/bin/q-ui https://github.com/IntelligentQuantum/q-ui/raw/main/q-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
